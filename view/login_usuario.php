			...
			<div class="caixa_login">
				...
				<div class="formulario_login">
					...
					<form id="frmLogar"  onsubmit="return logar(this)" action="router.php?controller=clientes&modo=logar">
						<input maxlength="100" type="email" value="claudio@teste.com.br" pattern="^([a-z._\-0-9áéíóúàèìòùâêîôûãẽĩõũç]*@+([a-z0-9]+.+[a-z0-9])*)+$" name="email" placeholder="Email" required>
						<input type="password" name="senha" value="123" placeholder="Senha" required><br>
