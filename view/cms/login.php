            ...
            <div class="login_painel">
                <form id="frmLogar" class="login_painel_form" onsubmit="return logar(this)">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><input maxlength="100" value="admin@mobshare.com" placeholder="admin@mobshare.com" type="email" pattern="^([a-z._\-0-9áéíóúàèìòùâêîôûãẽĩõũç]*@+([a-z0-9]+.+[a-z0-9])*)+$" name="txtEmail" required></td>
                        </tr>
                        <tr>
                            <td><label>Senha:</label></td>
                        </tr>
                        <tr>
                            <td><input type="password" value="123" placeholder="123" name="txtSenha" required></td>
                        </tr>
                        <tr>
                            <td>
                                <button>Logar</button>
