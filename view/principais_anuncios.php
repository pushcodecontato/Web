            ...
            <header>
                <div id="imgPretaRgb">
                    ...
                    <div class="caixa_texto_pages_all">
                        <h1 class="texto_primario_h1">Principais anuncios</h1>
                        <p class="texto_secundario_p"> Veículos à venda</p>
                    </div>
                </div>
            </header>
            <div id="conteudo">
                <div data-model="legend">
                ...
                <form role="search">
                    <div class="row" style="width: 1500px; margin-right: auto; margin-left: auto;">
