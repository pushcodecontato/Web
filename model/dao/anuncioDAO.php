<?php
    ...
    class AnuncioDAO{
        ...
        public function selectAllInteresadosByUser($id_cliente){
                $sql = "SELECT tbl_solicitacao_anuncio.id_cliente as id_locatario,tbl_anuncio.*,tbl_aprovacao_anuncio.status_aprovacao,if(tbl_solicitacao_anuncio.status_solicitacao = 0 ,'pendente',if(tbl_solicitacao_anuncio.status_solicitacao = 1,'Aprovado','Reprovado')) as 'status' ".
