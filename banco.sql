...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_acessorios` (
  ...
  INDEX `fk_tbl_acessorios_tbl_tipo_veiculos_idx` (`id_tipo_veiculo` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_marca_veiculo_tipo_veiculo` (
  ...
  INDEX `fk_tbl_marca_veiculo_tipo_veiculo_tbl_marca_veiculo_idx` (`id_marca_veiculo` ASC),
  INDEX `fk_tbl_marca_veiculo_tipo_veiculo_tbl_tipo_veiculo_idx` (`id_tipo_veiculo` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_modelo_veiculo` (
  ...
  INDEX `fk_tbl_modelo_veiculo_tbl_marca_veiculo_tipo_veiculo_idx` (`id_marca_tipo` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_veiculo` (
  ...
  INDEX `fk_tbl_veiculo_tbl_tipo_veiculo_idx` (`id_tipo_veiculo` ASC),
  INDEX `fk_tbl_tbl_veiculo_tbl_marca_veiculo_idx` (`id_marca_veiculo` ASC),
  INDEX `fk_tbl_veiculo_tbl_modelo_veiculo_idx` (`id_modelo_veiculo` ASC),
  INDEX `fk_tbl_veiculo_tbl_cliente_idx` (`id_cliente` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_anuncio` (
  ...
  INDEX `fk_tbl_usuario_tbl_anuncios_idx` (`id_cliente_locador` ASC),
  INDEX `fk_tbl_veiculos_tbl_anuncios_idx` (`id_veiculo` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_anuncio_venda` (
  ...
  INDEX `fk_tbl_usuario_tbl_anuncio_venda_idx` (`id_cliente` ASC),
  INDEX `fk_tbl_veiculo_tbl_anuncio_venda_idx` (`id_veiculo` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_usuario_cms` (
  ...
  INDEX `fk_tbl_usuario_cms_tbl_niveis_idx` (`id_niveis` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_aprovacao_anuncio` (
  ...
  INDEX `fk_tbl_aprovacao_anuncio_tbl_usuario_cms_idx` (`id_usuario_cms` ASC),
  INDEX `fk_tbl_aprovacao_anuncio_tbl_anuncio_idx` (`id_anuncio` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_aprovacao_anuncio_venda` (
  ...
  INDEX `fk_tbl_aprovacao_anuncio_tbl_usuario_cms_idx` (`id_usuario_cms` ASC),
  INDEX `fk_tbl_aprovacao_anuncio_venda_tbl_anuncio_venda_idx` (`id_anuncio_venda` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_locacao` (
  ...
  INDEX `fk_tbl_usuario_tbl_locacao_idx` (`id_cliente_locador` ASC),
  INDEX `fk_tbl_anuncio_tbl_locacao_idx` (`id_anuncio` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_funcionario` (
  ...
  INDEX `fk_tbl_setor_tbl_funcionario_idx` (`id_setor` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_cargo_funcionario` (
  ...
  INDEX `fk_tbl_setor_tbl_cargo_funcionario_idx` (`id_cargo` ASC),
  INDEX `fk_tbl_funcionario_tbl_cargo_funcionario_idx` (`id_funcionario` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_conta` (
  ...
  INDEX `fk_tbl_conta_bancaria_tbl_` (`id_banco` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_fale_conosco` (
  ...
  `nome_fale_conosco` VARCHAR(100) NULL DEFAULT NULL COMMENT 'nome da página fale conosco',
  ...
  `celular_fale_conosco` VARCHAR(20) NULL DEFAULT NULL COMMENT 'telefone da página fale conosco',
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_folha_pagamento` (
  ...
  INDEX `fk_tbl_pagamento_funcionario_tbl_funcionario_idx` (`id_funcionario` ASC),
  INDEX `fk_tbl_usuario_desktop_tbl_folha_pagamento_idx` (`id_usuario_desktop` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_folha_pagamento_contas_pagar` (
  ...
  INDEX `fk_tbl_funcionario_idx` (`id_folha_pagamento` ASC),
  INDEX `fk_tbl_contas_pagar_tbl_folha_pagamento_contas_pagar_idx` (`id_conta_pagar` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_foto_veiculo` (
  ...
  INDEX `fk_tbl_foto_veiculo_tbl_veiculo_idx` (`id_veiculo` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_locacao_conta_pagar` (
  ...
  INDEX `fk_tbl_pagamento_cliente_tbl_locacao_idx` (`id_locacao` ASC),
  INDEX `fk_tbl_contas_pagar_tbl_locacao_conta_pagar_idx` (`id_conta_pagar` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_locacao_conta_receber` (
  ...
  INDEX `fk_tbl_carteira_tbl_locacao_idx` (`id_locacao` ASC),
  INDEX `fk_tbl_contas_receber_tbl_locacao_conta_receber_idx` (`id_conta_receber` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_niveis_menu` (
  ...
  INDEX `fk_tbl_niveis_menu_tbl_niveis_idx` (`id_niveis` ASC),
  INDEX `fk_tbl_niveis_menu_tbl_menu_idx` (`id_menu` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_operacoes` (
  ...
  INDEX `fk_tbl_conta_tbl_operacoes_idx` (`id_conta` ASC),
  INDEX `fk_tbl_usuario_desktop_tbl_operacoes_idx` (`id_usuario_desktop` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_operacoes_contas_pagar` (
  ...
  INDEX `fk_tbl_contas_pagar_tbl_operacoes_contas_pagar_idx` (`id_contas_pagar` ASC),
  INDEX `fk_tbl_operacoes_tbl_operacoes_contas_pagar_idx` (`id_operacoes` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_operacoes_contas_receber` (
  ...
  INDEX `fk_tbl__contas_receber_tbl_operacoes_contas_receber_idx` (`id_contas_receber` ASC),
  INDEX `fk_tbl_operacoes_tbl_operacoes_contas_receber_idx` (`id_operacoes` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_pagina_sobre` (
  ...
  `titulo_missao_sobre` TEXT NOT NULL COMMENT 'missão página sobre',
  `texto_missao_sobre` TEXT NOT NULL,
  `foto_missao_sobre` TEXT NOT NULL,
  `titulo_visao_sobre` TEXT NOT NULL,
  `texto_visao_sobre` TEXT NOT NULL COMMENT 'visão página sobre',
  `foto_visao_sobre` TEXT NOT NULL,
  `titulo_valores_sobre` TEXT NOT NULL,
  `texto_valores_sobre` TEXT NOT NULL COMMENT 'valores da página sobre',
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_pedido` (
  ...
  INDEX `fk_tbl_pedidos_tbl_fornecedor_idx` (`id_fornecedor` ASC),
  INDEX `fk_tbl_usuario_desktop_tbl_pedido_idx` (`id_usuario_desktop` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_pedido_contas_pagar` (
  ...
  `id_conta_pagar` INT(11) NOT NULL COMMENT 'código da tabela contas à pagar',
  PRIMARY KEY (`id_pedido_contas_pagar`),
  INDEX `fk_tbl_pedido_tbl_pedido_contas_pagar_idx` (`id_pedido` ASC),
  INDEX `fk_tbl_contas_pagar_tbl_pedido_contas_pagar_idx` (`id_conta_pagar` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_pedido_produto` (
  ...
  INDEX `fk_produto_pedido_idx` (`id_pedido` ASC),
  INDEX `fk_tbl_produto_tbl_pedido_produto_idx` (`id_produto` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_percentual` (
  ...
  INDEX `id_tipo_veiculo` (`id_tipo_veiculo` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_percentual_desconto` (
  ...
  INDEX `fk_tbl_percentual_desconto_tbl_cliente_idx` (`id_cliente` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_principais_anuncios` (
  ...
  INDEX `fk_tbl_principais_anuncios_tbl_anuncios_venda_idx` (`id_anuncios_venda` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_salario` (
  ...
  INDEX `fk_tbl_funcionario_tbl_salario_idx` (`id_funcionario` ASC),
...
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_usuario_desktop_permissoes` (
  ...
  INDEX `fk_tbl_permicoes_idx` (`id_permicoes` ASC),
  INDEX `fk_tbl_usuario_desktop_tbl_usuario_desktop_permicoes_idx` (`id_usuario_desktop` ASC),
...
-- -----------------------------------------------------
-- Table `mob_share`.`tbl_anuncio_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_anuncio_copy1` (
  `id_anuncio` INT(11) NOT NULL COMMENT 'código da tabela anúncio',
  `descricao` TEXT NOT NULL COMMENT 'descrição da tabela de anúncio',
  `id_cliente_locador` INT(11) NOT NULL COMMENT 'código da tabela cliente locador',
  `id_veiculo` INT(11) NOT NULL COMMENT 'código da tabela de veículo',
  ...
  INDEX `fk_tbl_usuario_tbl_anuncios_idx` (`id_cliente_locador` ASC),
  INDEX `fk_tbl_veiculos_tbl_anuncios_idx` (`id_veiculo` ASC),
  CONSTRAINT `fk_tbl_usuario_tbl_anuncios0`
    FOREIGN KEY (`id_cliente_locador`)
    REFERENCES `mob_share`.`tbl_cliente` (`id_cliente`),
  CONSTRAINT `fk_tbl_veiculos_tbl_anuncios0`
    FOREIGN KEY (`id_veiculo`)
    REFERENCES `mob_share`.`tbl_veiculo` (`id_veiculo`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `mob_share`.`tbl_anuncio_venda_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_anuncio_venda_copy1` (
  `id_anuncio_venda` INT(11) NOT NULL COMMENT 'código do anúncio de venda',
  `id_veiculo` INT(11) NOT NULL COMMENT 'código da tabela do veículo',
  `id_cliente` INT(11) NOT NULL COMMENT 'código da tabela do cliente',
  `descricao_anuncio_venda` TEXT NOT NULL COMMENT 'descrição do anúncio de venda',
  ...
  INDEX `fk_tbl_usuario_tbl_anuncio_venda_idx` (`id_cliente` ASC),
  INDEX `fk_tbl_veiculo_tbl_anuncio_venda_idx` (`id_veiculo` ASC),
  CONSTRAINT `fk_tbl_usuario_tbl_anuncio_venda0`
    FOREIGN KEY (`id_cliente`)
    REFERENCES `mob_share`.`tbl_cliente` (`id_cliente`),
  CONSTRAINT `fk_tbl_veiculo_tbl_anuncio_venda0`
    FOREIGN KEY (`id_veiculo`)
    REFERENCES `mob_share`.`tbl_veiculo` (`id_veiculo`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `mob_share`.`tbl_aprovacao_anuncio_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_aprovacao_anuncio_copy1` (
  `id_aprovacao_anuncio` INT(11) NOT NULL AUTO_INCREMENT COMMENT 'código da tabela aprovação do anúncio',
  `status_aprovacao` TINYINT(4) NOT NULL COMMENT 'status da aprovação',
  `id_anuncio` INT(11) NOT NULL COMMENT 'código da tabela anúncio',
  `id_usuario_cms` INT(11) NOT NULL COMMENT 'código da tabela usuário do cms',
  ...
  INDEX `fk_tbl_aprovacao_anuncio_tbl_usuario_cms_idx` (`id_usuario_cms` ASC),
  INDEX `fk_tbl_aprovacao_anuncio_tbl_anuncio_idx` (`id_anuncio` ASC),
  CONSTRAINT `fk_tbl_avaliacao_anuncio_tbl_anuncio0`
    FOREIGN KEY (`id_anuncio`)
    REFERENCES `mob_share`.`tbl_anuncio_copy1` (`id_anuncio`),
  CONSTRAINT `fk_tbl_avaliacao_anuncio_tbl_usuario_cms0`
    FOREIGN KEY (`id_usuario_cms`)
    REFERENCES `mob_share`.`tbl_usuario_cms` (`id_usuario_cms`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `mob_share`.`tbl_aprovacao_anuncio_venda_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mob_share`.`tbl_aprovacao_anuncio_venda_copy1` (
  `id_aprovacao_anuncio_venda` INT(11) NOT NULL AUTO_INCREMENT COMMENT 'código de aprovação do anúncio de venda',
  `status_aprovacao` TINYINT(4) NOT NULL COMMENT 'status de aprovação do anúncio de venda',
  `id_anuncio_venda` INT(11) NOT NULL COMMENT 'código da tabela de anúncio de venda',
  `id_usuario_cms` INT(11) NOT NULL COMMENT 'código da tabela do usuário do cms',
  ...
  INDEX `fk_tbl_aprovacao_anuncio_tbl_usuario_cms_idx` (`id_usuario_cms` ASC),
  INDEX `fk_tbl_aprovacao_anuncio_venda_tbl_anuncio_venda_idx` (`id_anuncio_venda` ASC),
  CONSTRAINT `fk_tbl_avaliacao_anuncio_venda_tbl_anuncio_venda0`
    FOREIGN KEY (`id_anuncio_venda`)
    REFERENCES `mob_share`.`tbl_anuncio_venda_copy1` (`id_anuncio_venda`),
  CONSTRAINT `fk_tbl_avaliacao_anuncio_venda_tbl_usuario_cms0`
    FOREIGN KEY (`id_usuario_cms`)
    REFERENCES `mob_share`.`tbl_usuario_cms` (`id_usuario_cms`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
