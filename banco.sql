...
INSERT INTO `tbl_home_sessao3` VALUES (1,'bike.png','moto.png','car.png','Bicicletas','Motos','Carros','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc maximus.','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc maximus.','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc maximus.',1,'O que pode ser alugador?'),(18,'bike.png','moto.png','car.png','                       Bicicletas                    ','                       Motos                    ','                       Carros                    ','O uso da bicicleta como meio de transporte é cada vez mais frequente, porém nem todos possuem bike própria. anuncie já a sua !','muitas pessoas optam pela moto por ser&nbsp; um veiculo mais rápido e econômico, porem nem todos possuem moto própria.&nbsp; não perca tempo anuncie ja a sua!','Atualmente as pessoas estão atrás de alugar carros para trabalhar e ganhar uma renda extra no seu dia a dia, então se você já tem o seu, anuncie já&nbsp;',1,' O que pode ser alugador? '),(19,'bike.png','moto.png','car.png','                                              Bicicletas                                        ','                                              Motos                                        ','                                              Carros                                       ','O  uso da bicicleta como meio de transporte é cada vez mais frequente, porém nem todos possuem bike própria. anuncie já a sua !  ','                       muitas pessoas optam pela moto por ser&nbsp; um veiculo mais rápido e econômico, porem nem todos possuem moto própria.&nbsp; não perca tempo anuncie ja a sua!                    ','Os carros vem se tornando o veículos mais procurado pelas pessoas&nbsp; &nbsp;para estar trabalhando e ganhando uma renda extra, então se você já tem o seu, anuncie já&nbsp;                    ',1,'  O que pode ser alugador?  ');
...
CREATE TABLE `tbl_solicitacao_anuncio` (
  ...
  CONSTRAINT `fk_tbl_solicitacao_anuncio_tbl_locacao` FOREIGN KEY (`id_locacao`) REFERENCES `tbl_locacao` (`id_locacao`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-05-29 10:13:13
